      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-green-50 rounded-lg p-4 border border-green-100">
            <h3 className="text-lg font-medium text-gray-700 mb-2">Survey Respondents</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-6">
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <h3 className="text-lg font-medium text-gray-800 mb-4">Survey Responses</h3>
            <div className="h-64">
              <Bar 
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <h3 className="text-lg font-medium text-gray-800 mb-4">Role Satisfaction</h3>
            <div className="h-64">
              <Pie 
